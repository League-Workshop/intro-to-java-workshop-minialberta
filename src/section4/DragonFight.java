...
public class DragonFight {
	...
	int playerHealth=100;
		...
		String input=JOptionPane.showInputDialog(null,"Would you like to attack the dragon with a yell or a kick?");
		...
		JOptionPane.showMessageDialog(null, "Damage Dealt To Player "+playerDamage);
		JOptionPane.showMessageDialog(null,"Player Health "+playerHealth);
		JOptionPane.showMessageDialog(null, "Damage Dealt To Dragon "+dragonDamage);
